...
const ServiceWalkthrough = () => {
  return (
    <motion.div
      className="w-full max-w-sm sm:max-w-lg md:max-w-2xl lg:max-w-4xl xl:max-w-5xl mx-auto mt-6 sm:mt-8 md:mt-12 px-3 sm:px-4 md:px-6"
    ...
    >
      ...
      >
        ...
        <div className="relative bg-white/10 sm:bg-white/15 md:bg-white/20 backdrop-blur-md lg:backdrop-blur-lg rounded-xl sm:rounded-2xl md:rounded-3xl p-1.5 sm:p-2 md:p-3 lg:p-4 shadow-lg sm:shadow-xl md:shadow-2xl border border-white/15 sm:border-white/20 md:border-white/30 hover:shadow-xl sm:hover:shadow-2xl md:hover:shadow-3xl transition-all duration-500">
          ...
          >
            <iframe
              src="https://www.loom.com/embed/a8ad03e6ced84b039004129548203c69?sid=fcff3493-4c8f-4908-84a1-4b5f20a3d668&autoplay=1&loop=1&speed=1&hideEmbedTopBar=1&hide_owner=1&hide_share=1&hide_title=1&hideSpeedButton=1&hide_play_button=1&t=0"
              allowFullScreen
      ...
      <motion.div
        className="text-center mt-4 sm:mt-6 md:mt-8 px-2 sm:px-4"
  ...
  return (
    <div className="min-h-screen bg-gray-100 relative overflow-hidden py-20 lg:pt-30">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <motion.div
          className="absolute top-6 sm:top-10 md:top-16 lg:top-20 left-2 sm:left-4 md:left-8 lg:left-10 w-24 h-24 sm:w-32 sm:h-32 md:w-48 md:h-48 lg:w-80 lg:h-80 xl:w-96 xl:h-96 bg-[#069DDE] rounded-full filter blur-xl sm:blur-2xl md:blur-3xl opacity-15 sm:opacity-20 md:opacity-25"
          animate={{
            scale: [1, 1.1, 1],
        ...
        />
        <motion.div
          className="absolute top-3 sm:top-5 md:top-8 lg:top-10 right-1 sm:right-2 md:right-6 lg:right-8 w-20 h-20 sm:w-28 sm:h-28 md:w-40 md:h-40 lg:w-72 lg:h-72 xl:w-80 xl:h-80 bg-[#FF76591A] rounded-full filter blur-xl sm:blur-2xl md:blur-3xl opacity-15 sm:opacity-20 md:opacity-25"
          animate={{
            scale: [1, 1.15, 1],
        ...
        />
        <motion.div
          className="absolute top-40 sm:top-48 md:top-64 lg:top-80 xl:top-96 left-4 sm:left-6 md:left-12 lg:left-20 w-22 h-22 sm:w-28 sm:h-28 md:w-44 md:h-44 lg:w-64 lg:h-64 xl:w-80 xl:h-80 bg-[#EFD329] rounded-full filter blur-xl sm:blur-2xl md:blur-3xl opacity-10 sm:opacity-15 md:opacity-25"
          animate={{
            scale: [1, 1.2, 1],
        ...
        />
        <motion.div
          className="absolute top-52 sm:top-64 md:top-80 lg:top-96 xl:top-110 right-2 sm:right-4 md:right-8 lg:right-16 xl:right-30 w-18 h-18 sm:w-24 sm:h-24 md:w-36 md:h-36 lg:w-56 lg:h-56 xl:w-72 xl:h-72 bg-[#A0C366] rounded-full filter blur-xl sm:blur-2xl md:blur-3xl opacity-10 sm:opacity-15 md:opacity-25"
          animate={{
            scale: [1, 1.05, 1],
            opacity: [0.1, 0.2, 0.1],
          }}
      ...
      <div className="relative z-10 w-full px-3 sm:px-4 md:px-6 lg:px-8 pt-8 sm:pt-12 md:pt-16 lg:pt-20 pb-8 sm:pb-12 md:pb-16 lg:pb-20">
        <div className="text-center">
          {/* Animated heading */}
          <motion.h1
            className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-3 sm:mb-4 md:mb-6 px-2 sm:px-4"
            initial={{ opacity: 0, y: 50 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, ease: "easeOut" }}
          >
            <motion.span
              className="block xs:block sm:inline"
          ...
          <motion.p
            className="text-sm xs:text-base sm:text-lg md:text-xl lg:text-2xl text-gray-600 mb-6 sm:mb-8 md:mb-12 max-w-xs xs:max-w-sm sm:max-w-lg md:max-w-2xl lg:max-w-3xl xl:max-w-4xl mx-auto px-3 sm:px-4 leading-relaxed"
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
