// Student How It Works Component
"use client";
...
const HowItWorks = () => {
  ...
  return (
    <section className="bg-white py-12 sm:py-16 md:py-20 lg:py-24 xl:py-28 relative overflow-hidden">
        ...
        >
          {steps.map((step, index) => {
            ...
            return (
              <motion.div 
                key={index}
                className="bg-gray-50 hover:bg-gray-100 transition-colors duration-200 rounded-2xl p-6 sm:p-8 lg:p-10 flex flex-col justify-between min-h-[280px] sm:min-h-[320px] lg:min-h-[350px] group cursor-pointer"
              ...
              >
                ...
                <motion.div className="mb-6 sm:mb-8 lg:mb-12">
                  <motion.div 
                    className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-2xl flex items-center justify-center group-hover:scale-105 transition-transform duration-200 relative"
                ...
                <motion.div
                  className="absolute top-4 right-4 w-8 h-8 bg-white rounded-full flex items-center justify-center text-gray-400 font-bold text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                  initial={{ scale: 0 }}
                  whileHover={{ scale: 1 }}
                  transition={{ type: "spring", stiffness: 400 }}
                >
