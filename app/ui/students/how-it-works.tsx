...
const HowItWorks = () => {
  ...
  return (
    <section className="bg-gradient-to-b from-white to-blue-50 py-12 sm:py-16 md:py-20 lg:py-24 xl:py-28 relative overflow-hidden">
        ...
        >
          {steps.map((step, index) => {
            ...
            return (
              <motion.div 
                key={index}
                className="bg-white hover:bg-gray-50 transition-colors duration-200 rounded-lg sm:rounded-xl p-6 sm:p-8 lg:p-10 flex flex-col justify-between min-h-[280px] sm:min-h-[320px] lg:min-h-[350px] group cursor-pointer shadow-sm hover:shadow-md border border-gray-100 hover:border-blue-200"
                variants={stepVariants}
                whileHover={{ 
                  y: -2,
                  boxShadow: "0 20px 40px -10px rgba(6, 157, 222, 0.15)"
                }}
              ...
              >
                ...
                <motion.div className="mb-6 sm:mb-8 lg:mb-12">
                  ...
                  >
                    ...
                    <motion.div
                      className="absolute inset-0 rounded-lg sm:rounded-xl border-2 border-blue-300 opacity-0"
                      animate={{ 
                        scale: [1, 1.2, 1],
                        opacity: [0, 0.3, 0]
                      }}
                ...
                >
                  <motion.h3 
                    className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-2 sm:mb-3 lg:mb-4 group-hover:text-blue-600 transition-colors duration-300"
                ...
                {/* Subtle Accent Line */}
                <motion.div
                  className="absolute bottom-0 left-0 h-1 bg-gradient-to-r from-blue-500 to-blue-400 rounded-b-lg sm:rounded-b-xl transition-all duration-300 w-0 group-hover:w-full"
                />
              </motion.div>
            );
          })}
