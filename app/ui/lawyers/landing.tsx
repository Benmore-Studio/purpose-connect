...
export default function CaseManagementSection() {
  ...
  return (
    <section className="bg-gradient-to-br from-amber-50 to-yellow-50 flex items-center py-30 lg:py-40">
      <div className="container mx-auto px-6 max-w-md lg:max-w-7xl lg:px-0">
        ...
        >
          ...
          >
            <motion.button 
              className="w-full px-8 py-4 border-2 border-amber-500 text-amber-600 font-medium rounded-full hover:bg-amber-50 hover:border-amber-600 transition-all duration-300 text-lg"
              variants={fadeInUp}
            ...
            <motion.button 
              className="w-full px-8 py-4 bg-amber-500 text-white font-medium rounded-full hover:bg-amber-600 transition-all duration-300 text-lg"
              variants={fadeInUp}
          ...
          >
            ...
            >
              <motion.div
                className="absolute inset-0 bg-gradient-to-tr from-amber-500/10 to-transparent z-10 opacity-0"
            ...
            >
              <motion.div
                className="absolute inset-0 bg-gradient-to-tr from-yellow-500/10 to-transparent z-10 opacity-0"
                whileHover={{ opacity: 1 }}
                transition={{ duration: 0.3 }}
              />
              <Image
        ...
        <div className="hidden lg:grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              <motion.button 
                className="px-8 py-4 border-2 border-amber-500 text-amber-600 font-medium rounded-full hover:bg-amber-50 hover:border-amber-600 transition-all duration-300 text-lg"
                variants={fadeInUp}
                whileHover={{ scale: 1.05, boxShadow: "0 10px 25px rgba(245, 158, 11, 0.15)" }}
                whileTap={{ scale: 0.98 }}
              >
                Search Jobs
              </motion.button>
              ...
              <motion.button 
                className="px-8 py-4 bg-amber-500 text-white font-medium rounded-full hover:bg-amber-600 transition-all duration-300 text-lg"
                variants={fadeInUp}
                whileHover={{ scale: 1.05, boxShadow: "0 10px 25px rgba(245, 158, 11, 0.25)" }}
                whileTap={{ scale: 0.98 }}
              >
                Sign up Today
              </motion.button>
          ...
          >
            <div className="relative">
              ...
              >
                <motion.div
                  className="absolute inset-0 bg-gradient-to-tr from-yellow-500/10 to-transparent z-10"
                  initial={{ opacity: 0 }}
                  whileHover={{ opacity: 1 }}
                  transition={{ duration: 0.3 }}
                />
