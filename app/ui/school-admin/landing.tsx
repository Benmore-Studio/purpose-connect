...
export default function Landing() {
  ...
  return (
    <section className="flex items-center bg-gradient-to-br from-green-50 to-lime-50 py-30">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center w-full">
          ...
          >
            ...
            >
              ...
              >
                <motion.span 
                  className="bg-gradient-to-r from-green-600 to-lime-600 bg-clip-text text-transparent"
                  variants={fadeInUp}
                >
                  Support Your Students'
                </motion.span>
                <motion.span variants={fadeInUp}>
                  {" Career & Immigration Journey"}
                </motion.span>
              </motion.h2>
            ...
            >
              <motion.button 
                className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 border-2 border-green-500 text-green-600 font-medium rounded-full hover:bg-green-50 hover:border-green-600 transition-all duration-300 text-base sm:text-lg order-2 sm:order-1"
                variants={fadeInUp}
              ...
              <motion.button 
                className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-green-500 text-white font-medium rounded-full hover:bg-green-600 transition-all duration-300 text-base sm:text-lg order-1 sm:order-2"
                variants={fadeInUp}
                whileHover={{ scale: 1.05, boxShadow: "0 10px 25px rgba(34, 197, 94, 0.25)" }}
                whileTap={{ scale: 0.98 }}
              >
                Sign up Today
              </motion.button>
